...
#   @task_id
#   Scenario:  Verify POST comments can not create the comment with empty body
#       As a user I want to verisyfy a comment without body can not be created from TODOIST API
...
#  @task_id
#  Scenario Outline:  Verify POST section creates multiple comments correctly
#       As a user I want to create multiple comments from TODOIST API
...
#     | Third comment Created   |
#     | Fourth comment Created  |